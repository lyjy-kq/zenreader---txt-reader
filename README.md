...
5. **调整设置** - 点击右侧设置图标调整滚动幅度等参数
6. **键盘控制** - 使用快捷键进行流畅阅读（见下方）

### ⚙️ 阅读设置

点击右侧悬浮按钮中的"设置"图标，可以调整：

- **滚动幅度** - 调节每次按键滚动的距离（50-500像素）
- 预设选项：小(100px)、中(200px)、大(300px)、半屏(400px)、全屏(500px)
- 设置会自动保存，下次打开继续生效

### ⌨️ 键盘快捷键

阅读时支持以下快捷键，让你无需鼠标即可流畅操作：

| 按键 | 功能 |
|------|------|
| <kbd>W</kbd> / <kbd>↑</kbd> | 向上滚动页面 |
| <kbd>S</kbd> / <kbd>↓</kbd> / <kbd>空格</kbd> | 向下滚动页面 |
| <kbd>A</kbd> / <kbd>←</kbd> | 上一章 |
| <kbd>D</kbd> / <kbd>→</kbd> | 下一章 |
